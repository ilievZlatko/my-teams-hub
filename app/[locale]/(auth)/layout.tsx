...
export default function AuthLayout({
  ...
  return (
    <div
      className={cn(
        'flex w-full lg:flex-row flex-col lg:h-screen justify-evenly lg:items-end items-center bg-[radial-gradient(circle_at_left_bottom,_var(--tw-gradient-stops))] from-[#CFDDE1] from-20% via-[#FDFDFF] via-50% to-[#EFF4F5] to-90%',
      )}
    >
